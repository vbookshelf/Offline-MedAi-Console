...
- <strong>Multimodal:</strong> Chat using text and images (supports JPG, PNG, webp, dicom, dcm and multi-page PDFs). Each pdf page is processed as an image. This enables the model to see all visual details including graphs, embedded images and tables.
